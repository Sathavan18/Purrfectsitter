    ...
    <div className="container">
      <nav className="navbar">
        ...
        <div className="nav-search" onClick={() => navigate("/search")}>
          <span className="search-text"><IoMdSearch />Search Sitters</span>
        </div>
      ...
      <div className="dashboard-content">
        <div className="left-grid">
          <div className="grid-box edit-profile-box" onClick={() => navigate("/ownerprofilepage")}>
              <span>Edit Profile</span>
            </div>
            <div className="grid-box set-preferences-box" onClick={() => navigate("/petbookingpage")}>
              <span>Settings</span>
            </div>
            <div className="grid-box view-ratings-box" onClick={() => navigate("/review")}>
